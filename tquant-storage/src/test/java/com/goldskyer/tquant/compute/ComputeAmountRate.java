...
public class ComputeAmountRate
{
	public static void main(String[] args) throws Exception
	{
		final float riseRateFlag = 5f; //涨速大于5
		System.setProperty("java.util.Arrays.useLegacyMergeSort", "true");
		List<String> lines = IOUtils.readLines(new FileInputStream("/mnt/tquant/compute/sdf/20161026.txt"));
		...
		{
			if (pairs.get(i).tickId < (300 + 3600) && pairs.get(i).getAmountRate() > 0.01
					&& pairs.get(i).getRiseRate() > riseRateFlag 
